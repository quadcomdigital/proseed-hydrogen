...
const CATEGORIES = [
  {label: 'Pieno Campo', slug: 'frontpage', icon: <Sprout size={32} />},
  {label: 'Fiori', slug: 'fiori', icon: <Flower2 size={32} />},
  {label: 'Da Balcone', slug: 'balcone', icon: <Sun size={32} />},
  {label: 'Giardino', slug: 'giardino', icon: <Leaf size={32} />},
  {label: 'Idroponica', slug: 'idroponica', icon: <Droplets size={32} />},
  {label: 'Indoor', slug: 'indoor', icon: <Wind size={32} />},
];
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 lg:py-24">
      <div className="text-center mb-6 lg:mb-16">
        <h2 className="text-2xl lg:text-4xl font-black text-gray-900 mb-2">Inizia da qui</h2>
        <p className="text-gray-500 font-medium text-sm lg:text-base">Un solo sito per tutti i tuoi spazi</p>
      </div>
