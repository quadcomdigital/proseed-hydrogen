      ...
      <div className="flex items-center space-x-3">
        {shareLinks.map((link) => (
          <a
            ...
            className={`w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-400 transition-all ${link.hoverColor}`}
            title={link.label}
          >
            {link.icon}
          </a>
...
function FacebookIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3V2z"/></svg>;
}
